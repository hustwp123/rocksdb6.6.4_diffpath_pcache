...
class BlockFetcher {
 public:
  ...
  Status ReadBlockContents(int level=2);
 ...
 private:
  ...
  void InsertCompressedBlockToPersistentCacheIfNeeded(int level);
  void InsertUncompressedBlockToPersistentCacheIfNeeded(int level);
